...
class HCS04_Subscriber(Node):
    ...
    def __init__(self):
        ...
        #self.velocity_publisher = self.create_publisher(Twist, 'cmd_vel', self.calculate_wheel_velocity_callback, 10)
    ...
    def range_listener(self, msg):
        ...
        self.get_logger().info(f'Received Pulse Duration: {msg.range}, Calculated Distance: {distance} cm')
