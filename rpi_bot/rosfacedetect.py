...
def detect_and_draw(imgmsg, br , cascade):
...
def compressed_detect_and_draw(compressed_imgmsg, br, cascade):
...
def main(args=None):
    ...
    haarfile = '/usr/share/opencv4/haarcascades/haarcascade_frontalface_alt.xml'
    ...
    parser.add_option("-t", "--topic", action="store", dest="topic", type="str", help="Topic to find a face on, default %default", default = '/image_raw')
    parser.add_option("-s", "--ctopic", action="store", dest="ctopic", type="str", help="Compressed topic to find a face on, default %default", default = '/image_raw/compressed')
